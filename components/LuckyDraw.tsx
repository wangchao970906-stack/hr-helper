          ...
          <div className="relative z-10 flex flex-col items-center text-center px-6">
            ...
            <div className="h-32 flex items-center justify-center w-full">
              {activePool.length > 0 || isSpinning ? (
                <div className="space-y-2">
                  <h2 className={`text-5xl md:text-6xl font-black transition-all ${
                    isSpinning ? 'text-indigo-400 blur-[1px]' : 'text-white'
                  }`}>
            ...
            <div className="mt-16 flex flex-col gap-4 w-full max-w-xs">
              <button
                ...
                onClick={startDraw}
                className={`py-5 rounded-2xl text-xl font-bold flex items-center justify-center gap-3 transition shadow-lg ${
